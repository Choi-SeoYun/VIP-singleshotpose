...
class RegionLoss(nn.Module):
    def __init__(self, num_keypoints=9, num_classes=1, anchors=[], num_anchors=1, pretrain_num_epochs=15):
        ...
        self.num_anchors         = num_anchors # for single object pose estimation, there is only 1 trivial predictor (anchor)(single object 포즈 예측에서는 사소한 예측변수는 하나만 존재한다.)  # anchor는 2D에 표현되는 직사각형같다.
